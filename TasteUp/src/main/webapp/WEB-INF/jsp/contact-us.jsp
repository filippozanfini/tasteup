      ...
      <div class="contact-form">
        <form class="email-form">
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="esempio@esempio.com" />
          </div>
          <div class="form-group">
          ...
          <div id="contact-form" class="form-group">
            ...
            <textarea id="message-area" class="form-control" id="exampleFormControlTextarea1" rows="3"
