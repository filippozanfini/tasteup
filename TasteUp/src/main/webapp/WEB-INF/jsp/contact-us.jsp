  ...
  <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <div class="container-fluid contact-header">
        ...
        <img class="support-illustration" src="../../assets/illustrations/support.png">
        <div class="shadow-lg p-3 mb-5 bg-white contact-box">
          <div class="contact-category">
            <h2 class="contact-category-title">Hai bisogno di aiuto?</h2>
            <p class="contact-category-description">Se hai domande sul tuo ordine o hai bisogno di aiuto con l'utilizzo
              dell'app, mandaci una email a
              <a class="mail-link" href="mailto:support@tasteup.it">support@tasteup.it</a>
            </p>
          </div>
          <div class="contact-category">
            <h2 class="contact-category-title">Contatti Media</h2>
            <p class="contact-category-description">Per le interviste o altre richieste media, per favore scrivi una
              email a
              <a class="mail-link" href="mailto:press@tasteup.it">press@tasteup.it</a>
            </p>
          </div>
        </div>
      </div>
