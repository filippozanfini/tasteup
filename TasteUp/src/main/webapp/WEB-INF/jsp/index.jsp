    ...
    <body>
      ...
      <div id="header" class="headerSection">
        ...
        <div class="input-group">
          <form class="input-group" autocomplete="off" action="prodotti">
      ...
      <!-- CATEGORY SECTION -->
      <div class="row">
        <div class="col-lg-6" onclick="window.location='prodotti?product=panini';">
          <div class="cardpanino" style="background-image: url(../../assets/Panino.jpg)">
            <div class="card-body">
              <h5 id="panini-text" class="card-title">Panini</h5>
              <p class="card-description">Scopri la migliore selezione di panini, con verdure fresche e carni di
                qualità
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-6" onclick="window.location='prodotti?product=menu';">
