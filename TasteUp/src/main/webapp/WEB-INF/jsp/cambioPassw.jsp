<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Cambia la password - TasteUp</title>
        ...
        <body>
            ...
            <div class="page-content">
                ...
                <img id="image_ill2" src="/assets/illustrations/pwIcon.jpg">
                <div id="div_form" class="page-form">
                    <h3>Modifica Password</h3>

                    <img id="image" src="/assets/illustrations/keyIcon.png">

                    <div class="form-group">
                        <input id="form" class="form-control" type="email"
                            placeholder="Inserisci il tuo indirizzo email" name="username_login"
                            value="${usernameLogged}" readonly>
                    </div>

                    <div class="form-group">
                        <input id="form" class="form-control" type="password"
                            placeholder="Inserisci la tua nuova password" name="password_chngpsw">
                    </div>

                    <button id="passw-btn" class="modifica" value="confermaCambio"><span>Modifica</span></button>
