    ...
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
      ...
      <div class="headerSectionAddress">
        ...
        <div class=divIndirizzi>
          ...
          <a id="aggiungi_indirizzo" href="#myModal" class="aggiungiIndirizzo" data-toggle="modal">+ Aggiungi indirizzo</a>
        </div>
            ...
            <div class="modal-content">
              <form>
                ...
                <div class="modal-footer justify-content-between">
                  <button id="aggiungi" type="button" name="${usernameLogged}" ><span>Aggiungi indirizzo </span></button>
