<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>I tuoi indirizzi - TasteUp</title>
            ...
            <link rel="stylesheet" href="/css/accountAddress.css" type="text/css" />
            <link rel="stylesheet"
        ...
        <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse" id="main_nav">
                        <div class="offcanvas-header mt-3">
                            <button onclick="closeNav()" class="btn btn-close float-right"><svg
                                ...
                                <form method="POST" action="carrello">
                                    <a class="nav-link cart-link" aria-current="page" href="javascript:;"
                                        ...
                                        <svg class="cart-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                            width="33" height="33" viewBox="0 0 172 172" style=" fill:#000000;">
                                            <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
                                                stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                                stroke-dasharray="" stroke-dashoffset="0" font-family="none"
                                                font-weight="none" font-size="none" text-anchor="none"
                            ...
                            <c:if test="${usernameLogged != null}">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle account-link" data-toggle="dropdown" href="#"
                                        ...
                                        aria-expanded="false"><i><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                width="33" height="33" viewBox="0 0 172 172" style=" fill:#000000;">
                                                <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
                                                    stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                                    stroke-dasharray="" stroke-dashoffset="0" font-family="none"
            ...
            <!-- HEADER -->
            <div class="headerSectionAddress">
                <div>
                    <h1 id="h1_dati">I tuoi indirizzi</h1>
                ...
                <div class=divIndirizzi>
                    ...
                    <a id="aggiungi_indirizzo" href="#myModal" class="aggiungiIndirizzo" data-toggle="modal">+
                            ...
                            <form>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input id="form" name="nome" type="text" class="form-control"
                                            required="required">
                                    </div>
                                    <div class="form-group">
                                        <h7 id="text_form">Indirizzo</h7>
                                        <input id="form" name="indirizzo" type="text" class="form-control"
                                            required="required">
                                    </div>
                                    <div class="form-group">
                                        <h7 id="text_form">Citta'</h7>
                                        <input id="form" name="citta" type="text" class="form-control"
                                            required="required">
                                    </div>
                                    <div class="form-group">
                                        <h7 id="text_form">Cap</h7>
                                        <input id="form" name="cap" type="text" class="form-control"
                                            required="required">
                                    </div>
                                    <div class="form-group">
                                        <h7 id="text_form">Contatto </h7>
                                        <input id="form" name="numero_telefonico" type="text" class="form-control"
                                            required="required">
                                    </div>

                                </div>
                                <div class="modal-footer justify-content-between">
                                    <button id="aggiungi" type="button" name="${usernameLogged}"><span>Aggiungi
